...
opt.tooltips["name_vertical_offset"] = "名字文本位置的垂直偏移量"
...
opt.tooltips["nameonly_health_colour"] = "以部份染色的方式来显示血量百分比"
...
opt.tooltips["text_vertical_offset"] = "姓名板文字的全局垂直偏移量。针对WOW中某些比较奇怪的字体渲染作出微调。注意：尾数设为.5有助于在姓名板移动时减少抖动现象"
