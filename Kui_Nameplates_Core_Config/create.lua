...
fade_all:SetPoint('TOPLEFT',15,-300)
fade_alpha:SetPoint('LEFT',fade_all,'RIGHT',205,0)
fade_avoid_nameonly:SetPoint('TOPLEFT',fade_all,'BOTTOMLEFT')
...
colour_sep:SetPoint('TOP',0,-400)
colour_hated:SetPoint('TOPLEFT',15,-420)
