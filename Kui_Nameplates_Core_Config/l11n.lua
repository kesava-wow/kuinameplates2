...
opt.tooltips = {
    ...
    nameonly_in_combat = 'Use name-only mode even when a unit is in combat with you (also allows name-only mode to be enabled on enemy players)',
...
opt.titles = {
    ...
    nameonly_in_combat = 'On units you are attacking',
