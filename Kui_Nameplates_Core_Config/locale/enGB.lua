...
opt.tooltips = {
    ...
    auras_show_all_self = 'Show all auras which you cast, not including those filtered by other options.|n|nNote that this option is applied after the KuiSpellList filter, so you can still use |cffffff88KuiSpellListConfig from Curse|r to alter the spells displayed.',
