...
function healthbars:Initialise()
    ...
    local decimals_enabled = self:CreateCheckBox('decimals_enabled')
    local decimals_amount = self:CreateSlider('decimals_amount',1,3)
    ...
    decimals_enabled:SetPoint('TOPLEFT',decimals_sep,'BOTTOMLEFT',0,-5)
    decimals_amount:SetPoint('LEFT',decimals_enabled,'RIGHT',180,-5)
    ...
    decimals_amount.enabled = function(p) return p.decimals_enabled end
