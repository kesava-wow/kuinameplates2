...
L["titles"] = {
	...
	["bossmod_enable"] = "启用BOSS提醒插件交流",
	["bossmod_icon_size"] = "图标大小",
	["bossmod_line_width"] = "行宽",
	["bossmod_lines"] = "允许绘制线条",
	...
	["castbar_detach"] = "分离",
	["castbar_detach_combine"] = "叠加法术图标",
	["castbar_enable"] = "启用",
	["castbar_height"] = "施法条高度",
	["castbar_icon"] = "显示法术图标",
	["castbar_icon_side"] = "法术图标侧",
	["castbar_name"] = "显示法术名称",
	...
	["cvar_clamp_bottom"] = "吸附底部",
	["cvar_clamp_top"] = "吸附顶部",
	["cvar_disable_alpha"] = "禁用淡出",
	["cvar_disable_scale"] = "禁用缩放",
	["cvar_enable"] = "允许Kui Nameplates修改CVars",
	["cvar_max_distance"] = "最大可视距离",
	["cvar_name_only"] = "隐藏预设生命条",
	["cvar_occluded_mult"] = "视线外透明度",
	...
	["tankmode_trans_colour"] = "转换",
	["tankmode_trans_glow_colour"] = "转换",
...
L["tooltips"] = {
	...
	["auras_cd_size"] = "设置为0则使用“标准”字体大小",
	["auras_count_size"] = "设置为0则使用“小号”字体大小",
	...
	["bossmod_control_visibility"] = "允许首领警报插件控制友方名条的能见度",
	["bossmod_enable"] = "支持的BOSS提醒插件可以与KNP交流，显示特定首领战的光环并在姓名条上描绘线条。",
	["bossmod_icon_size"] = "首领光环图标大小",
	["bossmod_lines"] = "允许 Boss Mod 插件在铭牌上画线。颜色由 Boss Mod 决定。",
	...
	["cvar_disable_alpha"] = "|cffffcc00nameplate{Min,Max,Selected}Alpha|r|n|n停用姓名条的透明CVars参数 (除了以下的) 让它们不会干扰KNP的淡出规则。",
	["cvar_disable_scale"] = "|cffffcc00nameplate{Min,Max}Scale|r|n|n停用名条距离缩放CVars参数，它会破坏像素校正。",
	...
	["cvar_self_clamp_bottom"] = "|cffffcc00姓名条自身底部嵌入|r",
	["cvar_self_clamp_top"] = "|cffffcc00姓名条自身顶部嵌入|r",
