...
L["tooltips"] = {
	...
	["bossmod_lines"] = "允许首领提醒插件在姓名板上描绘线条,颜色取决于首领提醒插件.",
	...
	["classpowers_bar_height"] = "能量条的高度",
	["classpowers_bar_width"] = "能量条的宽度",
	["classpowers_colour"] = "当前职业的职业能量图标颜色",
	["classpowers_colour_inactive"] = "职业能量闲置是的图标颜色",
	["classpowers_colour_overflow"] = "职业能量\"溢出\"的颜色",
	["classpowers_enable"] = "显示职业特殊能量，像是连击点、圣能等等.",
	["classpowers_on_target"] = "显示于目标框体，不仅仅是个人姓名板",
	["classpowers_size"] = "职业能量图标尺寸",
	...
	["cvar_clamp_bottom"] = "|cffffcc00姓名板底部固定|r|n|n姓名板与屏幕底部边缘的距离，当设置为0代表完全贴齐边缘，设置为-0.1代表不要贴齐在萤幕边缘。|n|n只影响你的当前目标。",
	["cvar_clamp_top"] = "|cffffcc00姓名板顶部固定|r|n|n姓名板与屏幕顶部边缘的距离，当设置为0代表完全贴齐边缘，设置为-0.1代表不要贴齐在萤幕边缘。|n|n只影响你的当前目标。",
	["cvar_disable_alpha"] = "|cffffcc00最小透明度|n最大透明不|n设定的透明度|r|n|n停用姓名条的透明CVars参数 (除了以下的) 让它们不会干扰KNP的淡出规则。",
	["cvar_disable_scale"] = "|cffffcc00最小缩放|n最大缩放|n较大缩放|n设定的缩放|n默认缩放|r|n|n停用名条距离缩放CVars参数，它会破坏像素校正。",
	["cvar_enable"] = "启用后,Kui Nameplates将尝试将此页面上的CVar参数锁定到你所设置的值.|n|n如果取消此选项,KNP不会修改CVars,并将它们恢复为默认值.",
	["cvar_max_distance"] = "|cffffcc00最大可视距离|r|n|n姓名板可视的最大距离（不包含当前目标）",
	["cvar_name_only"] = "|cffffcc00隐藏预设生命条|r|n|n在友方姓名板无法被插件修改的情形下，隐藏预设姓名版的生命条。",
	["cvar_occluded_mult"] = "|cffffcc00超出距离透明度|r|n|n透明度系数适用于不在玩家视线内的姓名条。",
	["cvar_overlap_v"] = "|cffffcc00垂直堆叠间距|r|n|n姓名板彼此之间的垂直距离（只有在Esc > 介面 > 姓名板的选项中将排列类型设定为堆叠才有效）。",
	["cvar_personal_show_always"] = "|cffffcc00总是显示个人姓名板|r",
	["cvar_personal_show_combat"] = "|cffffcc00战斗中显示个人姓名板|r",
	["cvar_personal_show_target"] = "|cffffcc00有目标时显示个人姓名板|r|n|n如果你有可攻击的目标就显示个人姓名板。",
	["cvar_self_alpha"] = "|cffffcc00透明度|r|n|n透明度乘数适用于不在玩家视线内的名条。",
	["cvar_show_friendly_npcs"] = "|cffffcc00总是显示友方NPC姓名板|r",
