...
target_arrows:SetPoint('LEFT',state_icons,'RIGHT',190,0)
glow_as_shadow:SetPoint('TOPLEFT',ignore_uiscale,'BOTTOMLEFT')
target_glow:SetPoint('LEFT',ignore_uiscale,'RIGHT',190,0)
state_icons:SetPoint('TOPLEFT',glow_as_shadow,'BOTTOMLEFT')
target_glow_colour:SetPoint('TOPLEFT',ignore_uiscale,'BOTTOMLEFT',220,0)

frame_glow_size:SetPoint('TOPLEFT',state_icons,'BOTTOMLEFT',0,-20)
...
clickthrough_sep:SetPoint('TOP',0,-210)
clickthrough_self:SetPoint('TOPLEFT',15,-(210+10))
clickthrough_friend:SetPoint('TOPLEFT',(15+155),-(210+10))
clickthrough_enemy:SetPoint('TOPLEFT',(15+155*2),-(210+10))
...
fade_alpha:SetPoint('TOPLEFT',10,-(275+25))

fade_speed:SetPoint('LEFT',fade_alpha,'RIGHT',20,0)
fade_all:SetPoint('TOPLEFT',15,-(275+60))
...
local nameonly_neutral = nameonly:CreateCheckBox('nameonly_neutral')
...
nameonly_enemies:SetPoint('TOPLEFT',nameonly_all_enemies,'BOTTOMLEFT')
